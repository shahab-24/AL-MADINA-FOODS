...
const MyFood = () => {
          ...
          <table className="table-auto w-full border-collapse shadow-lg rounded-lg overflow-hidden">
            <thead>
              <tr className="bg-gradient-to-r from-green-400 to-green-600 text-white text-left">
                ...
                <th className="p-3 text-gray-900 dark:text-gray-200">Quantity</th>
  ...
  {myAddedFood.map((food, index) => (
    ...
    >
      ...
      <td className="p-4 text-gray-900 dark:text-white">{food.pickupLocation}</td>
      <td className="p-4 text-gray-900 dark:text-white">{food.foodQuantity}</td>
